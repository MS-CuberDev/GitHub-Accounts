...
const githubAccounts = users.map((person) => {
    return ` 
    <div class="card-accounts p-4 text-center" style="width: 18rem;">
        <img src="${person.avatar_url}" class="card-img-top mb-2" alt="Person">
        <div class="card-accounts-body">
            <h5 class="card-title mb-2">${person.login}</h5>
            <a href="${person.html_url}" class="card-link" target="_blank">GitHub Link</a>
        </div>
    </div>`
})

githubCards.innerHTML = githubAccounts.join('')